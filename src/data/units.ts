...
const fireSectionOptions: UnitOptionDef[] = [
  {
    ...
    choices: [
      ...
      { id: 'fs_lmg', name: 'Light Machine Gun' },
      {
        ...
        modifications: [{ targetName: 'Grenadier', addExtras: ['Frag Grenade', 'Fog Grenade'] }],
      },
  ...
  choices: [
    {
      id: 'armor_powered',
      name: 'Powered Armor',
      modifications: [{ setSlot: { armor: 'Powered Armor' } }],
    },
    {
      id: 'armor_breach',
      name: 'Breach Armor',
      modifications: [{ setSlot: { armor: 'Breach Armor' } }],
    },
  ],
};
...
export const unitOptions: Record<UnitType, UnitOptionDef[]> = {
  Infantry: [
    ...
    },
    {
      ...
      choices: [
        ...
        {
          id: 'support_grenade_launcher',
          name: 'Grenade Launcher',
          modifications: [{ targetName: 'Trooper 4', addExtras: ['Fog Grenade'] }],
        },
  ...
  Recon: [
    ...
    },
    {
      ...
      modifications: [{ addExtras: ['Service Pistol'] }],
    },
  ],
  Storm: [
    armorOptions,
      ...
      choices: [
        {
          id: 'storm_s1_flak',
          name: 'Flak Gun',
          modifications: [{ targetName: 'Trooper 2', setSlot: { rifle: 'Flak Gun' } }],
        },
        {
          id: 'storm_s1_flame',
          name: 'Flame Projector',
          modifications: [{ targetName: 'Trooper 2', setSlot: { rifle: 'Flame Projector' } }],
        },
        {
          id: 'storm_s1_fusion',
          name: 'Fusion Rifle',
          modifications: [{ targetName: 'Trooper 2', setSlot: { rifle: 'Fusion Rifle' } }],
        },
      ],
    },
    {
      ...
      choices: [
        {
          id: 'storm_s2_flak',
          name: 'Flak Gun',
          modifications: [{ targetName: 'Trooper 3', setSlot: { rifle: 'Flak Gun' } }],
        },
        {
          id: 'storm_s2_flame',
          name: 'Flame Projector',
          modifications: [{ targetName: 'Trooper 3', setSlot: { rifle: 'Flame Projector' } }],
        },
        {
          id: 'storm_s2_fusion',
          name: 'Fusion Rifle',
          modifications: [{ targetName: 'Trooper 3', setSlot: { rifle: 'Fusion Rifle' } }],
        },
      ],
    },
    // Penetrator grenades for the whole squad
    {
      ...
      modifications: [{ addExtras: ['Penetrator Grenade'] }],
    },
  ],
  'Weapon Team': [
    armorOptions,
      ...
      choices: [
        {
          id: 'enforcer_flak',
          name: 'Flak Gun',
          modifications: [{ targetName: 'Trooper 1', setSlot: { rifle: 'Flak Gun' } }],
        },
        {
          id: 'enforcer_grenade',
          name: 'Grenade Launcher',
          modifications: [{ targetName: 'Trooper 1', setSlot: { rifle: 'Grenade Launcher' } }],
        },
      ],
    },
  ],
  Militia: [
    ...
    squadVeteranSkills,
    {
      ...
      modifications: [{ targetName: 'Trooper 2', addExtras: ['Penetrator Grenade'] }],
    },
    {
      id: 'militia_support',
      name: 'Support Weapon',
      choices: [
        {
          id: 'militia_precision',
          name: 'Precision Rifle',
          modifications: [{ targetName: 'Trooper 1', setSlot: { rifle: 'Precision Rifle' } }],
        },
        {
          id: 'militia_light_machine_gun',
          name: 'Light Machine Gun',
          modifications: [{ targetName: 'Trooper 1', setSlot: { rifle: 'Light Machine Gun' } }],
        },
      ],
    },
  ],
      ...
      choices: [
        {
          id: 'sgt_blade',
          name: 'Blade',
          modifications: [{ targetName: 'Sergeant', setSlot: { melee: 'Blade' } }],
        },
        {
          id: 'sgt_powered_claw',
          name: 'Ripper Sword',
          modifications: [{ targetName: 'Sergeant', setSlot: { melee: 'Ripper Sword' } }],
        },
      ],
    },
    {
      ...
      modifications: [{ targetName: 'Sergeant', addExtras: ['Cling-fire Grenade'] }],
    },
    {
      id: 'pirate_axe_1',
      name: 'Breaching Axe (1st)',
      modifications: [{ targetName: 'Trooper 1', setSlot: { melee: 'Breaching Axe' } }],
    },
    {
      id: 'pirate_axe_2',
      name: 'Breaching Axe (2nd)',
      modifications: [{ targetName: 'Trooper 2', setSlot: { melee: 'Breaching Axe' } }],
    },
  ],
...
export const unitGroups = (
  ['Squads', 'Individuals', 'Specialists', 'Alternate Squad Types', 'Vehicles'] as UnitGroupLabel[]
).map((label) => ({
  label,
  types: (Object.keys(unitDefinitions) as UnitType[]).filter(
    (type) => unitTypeToGroup[type] === label
  ),
}));
