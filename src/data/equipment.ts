...
const _equipmentDefinitions = {
    ...
    'Fury Rifle': { points: 15, weapon: { range: 24, shots: 1, damage: 3, bonus: 2 }, traits: ['Heavy', 'Piercing', 'Knock Back', 'Team'] },
    'Plasma Rifle': { points: 8, weapon: { range: 20, shots: 2, damage: 1 }, traits: ['Focused', 'Piercing', 'Overheat', 'Team'] },
    'Sniper Rifle': { points: 10, weapon: { range: 40, shots: 1, damage: 1, bonus: 2 }, traits: ['Heavy', 'Piercing', 'Sniping', 'Team'] },
    ...
    'Fusion Rifle': { points: 10, weapon: { range: 15, shots: 1, damage: 3, bonus: 2 }, traits: ['Piercing', 'Team'] },
    // Melee
    ...
    // Crewed Weapons
    'Laser Cannon': { points: 35, weapon: { range: 48, shots: 1, damage: 5, bonus: 3 }, traits: ['Crewed'] },
    'Pulse Laser': { points: 35, weapon: { range: 36, shots: 2, damage: 4, bonus: 2 }, traits: ['Crewed'] },
    'Anti-tank Laser': { points: 45, weapon: { range: 60, shots: 1, damage: 6, bonus: 3 }, traits: ['Pin-point', 'Crewed'] },
    'Anti-tank missile': { points: 30, weapon: { range: 96, shots: 1, damage: 4, bonus: 4 }, traits: ['Minimum Range', 'Limited Supply', 'Lock On', 'Crewed'] },
    ...
    '75mm Cannon': { points: 45, weapon: { range: 60, shots: 1, damage: 5, bonus: 3 }, traits: ['Ammo Choice', 'Crewed', 'Frag Shell (D1, Area)'] },
    '100mm Cannon': { points: 55, weapon: { range: 72, shots: 1, damage: 6, bonus: 3 }, traits: ['Ammo Choice', 'Crewed', 'Frag Shell (D2, Area)'] },
    // Armor
...
export const equipmentDefinitions: Record<EquipmentName, EquipmentDef> =
  _equipmentDefinitions;

export const equipmentPoints: Record<EquipmentName, number> =
  Object.fromEntries(
    Object.entries(equipmentDefinitions).map(([name, def]) => [
      name,
      def.points,
    ]),
